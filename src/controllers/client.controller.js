...
//   id = req.params.id
//   req.getConnection((err, conn) => {
//     conn.query('select cliente.idCliente, Run, Nombre, Apellido, Telefono, Email, Nacionalidad from chileno inner join cliente on chileno_idCliente = chileno.idCliente inner join nacionalidad on nacionalidad_idNacionalidad = idNacionalidad where cliente.idCliente =(?)', [id],(err, result) => {
//         if(err){
//           res.json(err);
//         }
//         console.log(result)
